...
export declare function normalizeRawPackageManifest({ rawPackageManifest, rawPackument, registry, mirrors, cached, }: {
...
//# sourceMappingURL=normalize-raw-package-manifest.d.ts.map